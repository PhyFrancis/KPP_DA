...
place = '/home/daiqian/BGQ/32nt_kpp/L900_11_S0_11_Mu_0.000_Ms_0.045/';
all_traj = [288:4:328,662:4:678];
% all_traj = [282:4:646,290:8:334,502:8:646];
L_size = 32;
t_size = 64;
GparityX = 1; % 1 if using Gparity
GparityY = 1;
...
% place = '/home/daiqian/BGQ/16nt_kpp/L100_11_S0_11_Mu_0.010_Ms_0.099_2twist_swave/';
% all_traj = [1010:20:2030];
% L_size = 16;
% t_size = 32;
% GparityX = 1; % 1 if using Gparity
% GparityY = 1;
